...
class RechercheBtAvecPFParCodeproduitEtCodepostalEtDateResponse extends AbstractStructBase
{
    ...
    public static function validateReturnForArrayConstraintsFromSetReturn(?array $values = []): string
    {
        ...
        foreach ($values as $rechercheBtAvecPFParCodeproduitEtCodepostalEtDateResponseReturnItem) {
            ...
            if (!$rechercheBtAvecPFParCodeproduitEtCodepostalEtDateResponseReturnItem instanceof \StructType\BureauDeTabacAvecPF) {
     ...
     * @param \StructType\BureauDeTabacAvecPF[] $return
     * @return \StructType\RechercheBtAvecPFParCodeproduitEtCodepostalEtDateResponse
     */
