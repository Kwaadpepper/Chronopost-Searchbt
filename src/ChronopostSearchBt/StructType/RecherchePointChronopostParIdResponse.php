...
class RecherchePointChronopostParIdResponse extends AbstractStructBase
{
    ...
    public static function validateReturnForArrayConstraintFromSetReturn(?array $values = []): string
    {
        ...
        foreach ($values as $recherchePointChronopostParIdResponseReturnItem) {
            ...
            if (!$recherchePointChronopostParIdResponseReturnItem instanceof \ChronopostSearchBt\StructType\PointChronopost) {
     ...
     * @param \ChronopostSearchBt\StructType\PointChronopost[] $return
     * @return \ChronopostSearchBt\StructType\RecherchePointChronopostParIdResponse
     */
