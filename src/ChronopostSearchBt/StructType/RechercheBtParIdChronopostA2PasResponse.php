...
class RechercheBtParIdChronopostA2PasResponse extends AbstractStructBase
{
    ...
    public static function validateReturnForArrayConstraintFromSetReturn(?array $values = []): string
    {
        ...
        foreach ($values as $rechercheBtParIdChronopostA2PasResponseReturnItem) {
            ...
            if (!$rechercheBtParIdChronopostA2PasResponseReturnItem instanceof \ChronopostSearchBt\StructType\BureauDeTabacAvecCoord) {
     ...
     * @param \ChronopostSearchBt\StructType\BureauDeTabacAvecCoord[] $return
     * @return \ChronopostSearchBt\StructType\RechercheBtParIdChronopostA2PasResponse
     */
